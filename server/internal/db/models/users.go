...
type User struct {
	...
	Clid string `boil:"clid" json:"clid" toml:"clid" yaml:"clid"`
...
var UserWhere = struct {
	...
	Clid whereHelperstring
}{
	User: whereHelperstring{field: "\"users\".\"user\""},
	Clid: whereHelperstring{field: "\"users\".\"clid\""},
}
...
var (
	userAllColumns            = []string{"user", "clid"}
	userColumnsWithoutDefault = []string{"user", "clid"}
	userColumnsWithDefault    = []string{}
	userPrimaryKeyColumns     = []string{"user", "clid"}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, user string, clid string, selectCols ...string) (*User, error) {
	userObj := &User{}
	...
	query := fmt.Sprintf(
		"select %s from \"users\" where \"user\"=$1 AND \"clid\"=$2", sel,
	)

	q := queries.Raw(query, user, clid)
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"users\" WHERE \"user\"=$1 AND \"clid\"=$2"
...
func (o *User) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindUser(ctx, exec, o.User, o.Clid)
	if err != nil {
		return err
	}
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, user string, clid string) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"users\" where \"user\"=$1 AND \"clid\"=$2 limit 1)"

	if boil.IsDebug(ctx) {
		writer := boil.DebugWriterFrom(ctx)
		fmt.Fprintln(writer, sql)
		fmt.Fprintln(writer, user, clid)
	}
	row := exec.QueryRowContext(ctx, sql, user, clid)
...
func (o *User) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return UserExists(ctx, exec, o.User, o.Clid)
}
